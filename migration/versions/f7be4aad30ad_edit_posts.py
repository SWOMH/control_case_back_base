...
Revision ID: f7be4aad30ad
Revises: dc3fdbf2bbc8
Create Date: 2025-09-18 20:15:22.615687
...
revision: str = 'f7be4aad30ad'
down_revision: Union[str, Sequence[str], None] = 'dc3fdbf2bbc8'
...
def upgrade() -> None:
    ...
    op.add_column('comments_posts', sa.Column('user_reply_id', sa.Integer(), nullable=True))
    op.drop_constraint(op.f('comments_posts_parent_id_fkey'), 'comments_posts', type_='foreignkey')
    op.drop_constraint(op.f('comments_posts_user_id_fkey'), 'comments_posts', type_='foreignkey')
    op.drop_constraint(op.f('comments_posts_post_id_fkey'), 'comments_posts', type_='foreignkey')
    op.create_foreign_key(None, 'comments_posts', 'users', ['user_reply_id'], ['id'], source_schema='public', referent_schema='public')
    op.create_foreign_key(None, 'comments_posts', 'users', ['user_id'], ['id'], source_schema='public', referent_schema='public')
    op.create_foreign_key(None, 'comments_posts', 'comments_posts', ['parent_id'], ['id'], source_schema='public', referent_schema='public', ondelete='CASCADE')
    op.create_foreign_key(None, 'comments_posts', 'posts', ['post_id'], ['id'], source_schema='public', referent_schema='public', ondelete='CASCADE')
    op.create_foreign_key(None, 'comments_posts', 'users', ['user_reply_id'], ['id'], source_schema='public', referent_schema='public', ondelete='SET NULL')
    ...
    op.create_foreign_key(None, 'likes', 'posts', ['post_id'], ['id'], source_schema='public', referent_schema='public', ondelete='CASCADE')
    op.create_foreign_key(None, 'likes', 'users', ['user_id'], ['id'], source_schema='public', referent_schema='public')
    ...
    op.drop_constraint(op.f('posts_author_id_fkey1'), 'posts', type_='foreignkey')
    op.create_foreign_key(None, 'posts', 'users', ['author_id'], ['id'], source_schema='public', referent_schema='public')
    op.create_foreign_key(None, 'posts', 'users', ['author_id'], ['id'], source_schema='public', referent_schema='public', ondelete='SET NULL')
...
def downgrade() -> None:
    ...
    op.drop_constraint(None, 'posts', schema='public', type_='foreignkey')
    op.create_foreign_key(op.f('posts_author_id_fkey1'), 'posts', 'users', ['author_id'], ['id'], ondelete='SET NULL')
    ...
    op.drop_constraint(None, 'likes', schema='public', type_='foreignkey')
    op.drop_constraint(None, 'likes', schema='public', type_='foreignkey')
    ...
    op.drop_constraint(None, 'comments_posts', schema='public', type_='foreignkey')
    op.drop_constraint(None, 'comments_posts', schema='public', type_='foreignkey')
    op.drop_constraint(None, 'comments_posts', schema='public', type_='foreignkey')
    op.drop_constraint(None, 'comments_posts', schema='public', type_='foreignkey')
    op.drop_constraint(None, 'comments_posts', schema='public', type_='foreignkey')
    op.create_foreign_key(op.f('comments_posts_post_id_fkey'), 'comments_posts', 'posts', ['post_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(op.f('comments_posts_user_id_fkey'), 'comments_posts', 'users', ['user_id'], ['id'])
    op.create_foreign_key(op.f('comments_posts_parent_id_fkey'), 'comments_posts', 'comments_posts', ['parent_id'], ['id'], ondelete='CASCADE')
    op.drop_column('comments_posts', 'user_reply_id')
